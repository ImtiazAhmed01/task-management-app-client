...
const Footer = () => {
    ...
    // }
    return (
        <footer className="footer footer-center bg-black text-white rounded p-10 mt-10">
            <h1 className='text-3xl font-extrabold'>TaskForce</h1>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-black text-[#3F0113] bg-opacity-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg w-1/3">
                        ...
                        <p className="mb-4">
                            At TaskForce Ltd, we value your privacy. This Privacy Policy outlines how we collect,
